...
public class WxInterceptorConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
         ...
         * 其他的链接必须登录才能获取
         */
        registry.addInterceptor(new WeixinLoginHandlerInterceptor()).addPathPatterns("/weixin/**").excludePathPatterns("/weixin/order/**","/weixin/check/**","/weixin/user/**","/weixin/auth/*","/weixin/view/**","/weixin/route/**",
                "/weixin/search/**");
