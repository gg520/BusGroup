...
public class SortUtil {
     ...
     */
    public  static  final List<NewStation> stationSort(List<Station> stationList,String [] stringsCoord){
        List<NewStation> newStationList=new ArrayList<>();
        for(int i=0;i<stationList.size();i++){
            ...
            newStation.setStationName(stationList.get(i).getStationName());
            newStation.setStationId(stationList.get(i).getStationId());
